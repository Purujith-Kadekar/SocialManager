                ...
                <form onSubmit={handleSignup} className="space-y-3">
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input id="fullName" name="fullName" placeholder="John Doe" className="pl-9" />
                    </div>
                  </div>
                  <div className="space-y-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input id="password" name="password" type="password" required minLength={6} placeholder="At least 6 characters" className="pl-9" />
                    </div>
                  </div>
